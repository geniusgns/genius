...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #geniuscoinTEST\r");
            Send(hSocket, "WHO #geniuscoinTEST\r");
        } else
        {
	    LogPrintf("JOIN #geniuscoin\n");
            // randomly join #geniuscoin00-#geniuscoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #geniuscoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #geniuscoin%02d\r", channel_number).c_str());
        };
