...
#endif
    setObjectName("genius");
    setStyleSheet("#genius { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #efefef, stop: 1 #dedeff);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving coins"));
    ...
    aboutAction = new QAction(tr("&About Genius"), this);
